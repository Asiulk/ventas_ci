                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="POST">
                            ...
                            <div class="form-group <?php echo !empty(form_error('igv')) ? 'has-error':'';?>">
                                <label for="igv">Iva:</label>
                                <input type="text" class="form-control" id="igv" name="igv" value="<?php echo !empty(form_error('igv')) ? set_value('igv'):$producto->igv?>">
                                <?php echo form_error("igv","<span class='help-block'>","</span>");?>
                            </div>
